    ...
    try {
      ...
      if (response.ok) {
        ...
        setImages([
          {
            id: '1',
            url: 'process.env.REACT_APP_BACKEND_URL + "/photo-1570125909232-eb263c188f7e?w=400&h=300&fit=crop"',
            title: 'Force Urbania',
            category: 'vehicles',
          ...
          {
            id: '2', 
            url: 'process.env.REACT_APP_BACKEND_URL + "/photo-1506905925346-21bda4d32df4?w=400&h=300&fit=crop"',
          ...
          {
            id: '3',
            url: 'process.env.REACT_APP_BACKEND_URL + "/photo-1548013146-72479768bada?w=400&h=300&fit=crop"', 
